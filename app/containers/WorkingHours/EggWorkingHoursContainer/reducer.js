...
function eggPaginatedWorkingHoursContainerReducer(
  state = initialState,
  action
) {
  switch (action.type) {
    case LOAD_PAGINATED_INFO_OF_EGG_WORKING_HOURS:
      return state.set('loading', true).set('error', null);
    case LOAD_PAGINATED_INFO_OF_EGG_WORKING_HOURS_SUCCESS:
      return state
    ...
    case LOAD_PAGINATED_INFO_OF_EGG_WORKING_HOURS_ERROR:
...
export default eggPaginatedWorkingHoursContainerReducer;
